...
namespace FacturasSRI.Infrastructure.Services
{
    public class CobroService : ICobroService
    {
        ...
        public CobroService(FacturasSRIDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<CobroDto> RegistrarCobroAsync(RegistrarCobroDto cobroDto)
        {
            ...
            return new CobroDto
            {
                ...
                ClienteNombre = cuentaPorCobrar.Cliente.RazonSocial,
